...
for i in tqdm(range(12)):
    ...
    fig.savefig("storage_plots/"+mc_name[i]+"_"+mc_tag_out[i]+"Iteration"+str(iteration)+"_Step2_Q2.pdf",bbox_inches='tight')
    np.save("storage_files_old_pT_bin/"+mc_name[i]+"_"+mc_tag_out[i]+"n_Omni_step2_Q2_iteration"+str(iteration),n_Omni_step2_Q2)
    ...
    fig.savefig("storage_plots/"+mc_name[i]+"_"+mc_tag_out[i]+"Iteration"+str(iteration)+"_Step2_Q2_zoomed.pdf",bbox_inches='tight')
    np.save("storage_files_old_pT_bin/"+mc_name[i]+"_"+mc_tag_out[i]+"n_Omni_step2_Q2_zoomed_iteration"+str(iteration),n_Omni_step2_Q2)
