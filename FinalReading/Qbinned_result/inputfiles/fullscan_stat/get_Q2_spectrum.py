...
for seed in tqdm(np.concatenate([range(1,30),range(34,45),[46,47,48,49],range(54,66),range(80,86),range(100,106),range(120,126)])):
    ...
    for i in tqdm(range(1)):
        ...
        fig.savefig("storage_plots/"+mc_name[i]+"_"+mc_tag_out[i]+"Iteration"+str(iteration)+"_"+str(seed)+"_Step2_Q2.pdf",bbox_inches='tight')
        np.save("storage_files_old_pT_bin/"+mc_name[i]+"_"+mc_tag_out[i]+"n_Omni_step2_Q2_iteration"+str(iteration)+"_"+str(seed),n_Omni_step2_Q2)
        ...
        fig.savefig("storage_plots/"+mc_name[i]+"_"+mc_tag_out[i]+"Iteration"+str(iteration)+"_"+str(seed)+"_Step2_Q2_zoomed.pdf",bbox_inches='tight')
        np.save("storage_files_old_pT_bin/"+mc_name[i]+"_"+mc_tag_out[i]+"n_Omni_step2_Q2_zoomed_iteration"+str(iteration)+"_"+str(seed),n_Omni_step2_Q2)
