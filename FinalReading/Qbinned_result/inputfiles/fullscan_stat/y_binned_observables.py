...
for seed in tqdm(np.concatenate([range(1,30),range(34,45),[46,47,48,49],range(54,66),range(80,86),range(100,106),range(120,126)])):
    ...
    for i in range(1):
        ...
        for run_iter in range(5):
            mymodel = tf.keras.models.load_model("/global/home/users/yxu2/disjets/FinalReading/inputfiles/fullscan_stat/models/"+mc_name[i]+"_"+mc_tag_out[i]+"_iteration"+str(run_iter)+"_"+str(seed)+"_step2", compile=False)
